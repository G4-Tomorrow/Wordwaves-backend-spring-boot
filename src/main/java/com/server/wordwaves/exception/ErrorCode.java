...
public enum ErrorCode {
    ...
    USER_NOT_EXISTED(1008, "Tài khoản người dùng với ID không tồn tại", HttpStatus.BAD_REQUEST),
    WRONG_PASSWORD(1009, "Mật khẩu không chính xác", HttpStatus.BAD_REQUEST),
    USER_EXISTED(1010, "Tài khoản người dùng đã tồn tại", HttpStatus.BAD_REQUEST),
    ...
    CANNOT_DELETE_BASIC_ROLE(4008, "Không thể xóa vai trò cơ bản", HttpStatus.BAD_REQUEST),
    CANNOT_REMOVE_BASIC_ROLE(4009, "Không thể xóa vai trò cơ bản", HttpStatus.BAD_REQUEST),
    USER_DOES_NOT_HAVE_ROLE(4010, "Người dùng không có vai trò yêu cầu", HttpStatus.BAD_REQUEST),
    NO_ROLES_CAN_BE_REMOVED(4011, "Không có vai trò nào có thể xóa", HttpStatus.BAD_REQUEST),
    NO_ROLES_TO_ADD(4012, "Người dùng đã có các vai trò này trước đó nên không thể thêm mới vai trò", HttpStatus.BAD_REQUEST),
    INVALID_TYPE(4013, "Loại hành động không hợp lệ, chỉ chấp nhận ADD hoặc REMOVE", HttpStatus.BAD_REQUEST),
